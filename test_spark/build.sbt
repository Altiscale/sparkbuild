...
// libraryDependencies += "local.org.apache.spark" % "spark-assembly_2.10" % "1.4.0"

// libraryDependencies += "local.org.apache.spark" % "spark-sql_2.10" % "1.4.0"

// libraryDependencies += "local.org.apache.spark" % "spark-catalyst_2.10" % "1.4.0"
