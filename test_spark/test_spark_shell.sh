...
./bin/spark-shell --verbose --master yarn --deploy-mode client --queue research --driver-memory 2048M --conf spark.eventLog.dir=${spark_event_log_dir}$USER/ $spark_opts_extra << EOT
