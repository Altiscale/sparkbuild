...
all_nonkerberos_testcase=(test_spark_submit.sh test_spark_shell.sh test_spark_sql.sh test_spark_hql.sh test_spark_hql.kerberos.sh test_pyspark_sparksql.sh test_sparksql_shell.sh)
all_kerberos_testcase=(test_spark_submit.sh test_spark_shell.sh test_spark_sql.sh test_spark_hql.kerberos.sh test_pyspark_sparksql.sh test_sparksql_shell.sh)
